#' Estimate a linear regression model with the Wishart mechanism
#'
...
#' of tidy.lm
#' 
lm_wishart <- function(formula, data, epsilon, delta, var_names, var_types, bounds, reference_classes, alpha = 0.05) {
