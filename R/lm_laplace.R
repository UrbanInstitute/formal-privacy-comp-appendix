#' Estimate a linear regression model with the Laplacian mechanism
#'
...
#' of tidy.lm
#' 
lm_laplace <- function(formula, data, epsilon, var_names, var_types, bounds, reference_classes, alpha = 0.05) {
